...
public class ProviderController extends BaseController {
	...
	public String getProviderList(Model model,
		...
		model.addAttribute("contentPage", "providerlist");
		return "main";
	}
	...
	public String add(@ModelAttribute("provider") Provider provider, Model model) {
		model.addAttribute("contentPage", "provideradd");
		return "main";
	}
	...
	public String view(@PathVariable String id, Model model, HttpServletRequest request) {
		...
		model.addAttribute("contentPage", "providerview");
		return "main";
	}
	...
	public String getProviderById(@PathVariable String id, Model model, HttpServletRequest request) {
		...
		model.addAttribute(provider);
		model.addAttribute("contentPage", "providermodify");
		return "main";
	}
	...
	public String modifyProviderSave(Provider provider, HttpSession session, HttpServletRequest request,
		...
		if (flag) {
			provider.setModifyBy(((User) userService.getUserByCode(session.getAttribute(Constants.USER_SESSION).toString())).getId());
	...
	public String addProviderSave(Provider provider, HttpSession session, HttpServletRequest request,
		...
		if (flag) {
			provider.setCreatedBy(((User) userService.getUserByCode(session.getAttribute(Constants.USER_SESSION).toString())).getId());
