...
public class BaseController {
	...
	public void initBinder(WebDataBinder dataBinder) {
		 ...
		 * PropertyEditorSupport() { public void setAsText(String value) {
		 * System
		 * .out.println("InitBinder setAsText value=======================" +
		 * value); try { setValue(new
		 * SimpleDateFormat("yyyy-MM-dd").parse(value)); } catch(ParseException
		 * e) { System.out.println(e.getMessage()); e.printStackTrace();
		 * setValue(null); } } public String getAsText() {
