...
public class RoleController {
	...
	public String getRoleList(Model model) {
		...
		model.addAttribute("contentPage", "rolelist");
		return "main";
	}

	@RequestMapping(value = "/add.html", method = RequestMethod.GET)
	public String addRole(@ModelAttribute("role") Role role, Model model) {
		model.addAttribute("contentPage", "roleadd");
		return "main";
	}

	@RequestMapping(value = "/addsave.html", method = RequestMethod.POST)
	public String addRoleSave(Role role, HttpSession session, Model model) {
		role.setCreatedBy(((User) userService.getUserByCode(session.getAttribute(Constants.USER_SESSION).toString())).getId());
	...
	public String getUserById(@PathVariable String id, Model model, HttpServletRequest request) {
		...
		model.addAttribute("contentPage", "rolemodify");
		return "main";
	}

	@RequestMapping(value = "/modifysave.html", method = RequestMethod.POST)
	public String modifyUserSave(Role role, HttpSession session, Model model) {
		role.setModifyBy(((User) userService.getUserByCode(session.getAttribute(Constants.USER_SESSION).toString())).getId());
